export const shopifyAppExtensionUiDevelopmentRules = [
  {
    title: "Shopify App Extension UI Development Guidelines",
    tags: ["Shopify", "App Extension", "UI Development", "Best Practices", "Preact", "Polaris", "Web Components", "TypeScript"],
    slug: "shopify-app-extension-ui-development",
    libs: ["Preact", "Polaris", "Web Components", "TypeScript"],
    content: `
# Shopify App Extension UI Development Best Practices

Always stick to this guide which provides best practices, patterns, and common pitfalls for developing Shopify App Extension UI using Preact and Polaris web components.
...
App Extension UI extensions are self-contained modules that:
...
`,
    author: {
      name: "eyyMinda", // Optional
      url: "http://eyyminda.vercel.app/", // Optional
      avatar: "https://avatars.githubusercontent.com/u/100799754?v=4", // Optional
    }
  }
];